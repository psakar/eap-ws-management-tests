...
public class LogicalSourceHandlerInModule extends GenericLogicalHandler<LogicalMessageContext> {
  static final String INBOUND_APPENDIX = ":Inbound:LogicalSourceHandlerInModule";
  static final String OUTBOUND_APPENDIX = ":Outbound:LogicalSourceHandlerInModule";
  // provide logging
  private static final Logger log = Logger.getLogger(LogicalSourceHandlerInModule.class);
